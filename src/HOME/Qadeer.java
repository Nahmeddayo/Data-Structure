...
public class Qadeer extends Application{
	...
	public void start(Stage stage) throws Exception {
		...
		Label label = new Label("Profile");
 	      ...
 	      label.setTextFill(Color.BLACK);
	        ...
	        r2.setWidth(350);
	        r2.setHeight(550);
	        Image img = new Image("file:Image/Qadeer.JPEG");
	        ...
	        Label label1 = new Label("Details");
	         ...
	         Label label3 = new Label("Qadeer Ahmed");
	         ...
	         Text txt1=new Text(".Logo Designer");
	         ...
	         Hyperlink link = new Hyperlink("https://github.com/Nahmeddayo");
	          ...
	          Label label8 = new Label("Email :");
		         ...
		         Hyperlink link1 = new Hyperlink("Qadeer.53060@gmail.com");
		          ...
		          Label label9 = new Label("About Me");
			 		...
			 		Text txt2=new Text("I am a Graphic\nDesigner. I have also\nGood Knowledge About\nLogo Designing and \nAdobe Illustrator.");
