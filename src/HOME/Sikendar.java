...
public class Sikendar extends Application{
	...
	public void start(Stage stage) throws Exception {
		...
		Label label = new Label("Profile");
 	      ...
 	      label.setTextFill(Color.BLACK);
	        ...
	        r2.setWidth(350);
	        r2.setHeight(550);
	        Image img = new Image("file:Image/Sikendar.JPEG");
	        ...
	        Label label1 = new Label("Details");
	         ...
	         Label label3 = new Label("Sikendar Mehdi");
	         ...
	         Text txt1=new Text(".Backend Development\n.Node.Js\n.MongoDB,\n.Sql");
	         ...
	         Hyperlink link = new Hyperlink("https://github.com/Nahmeddayo");
	          ...
	          Label label8 = new Label("Email :");
		         ...
		         Hyperlink link1 = new Hyperlink("Syeda.51976@gmail.com");
